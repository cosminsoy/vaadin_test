...
import org.vaadin.helloworld.backend.repository.ContactRepository;
...
@Service  /*makes Spring aware of this service means that spring wil initialize the class and
        it will provide  us with implementations of both of these repositories (ContactRepository below) that we created we'll save them into fields
        and then we determine or define the API that we want our UI to have access to, findAll() count() delete() */
